var i18n_en = {
    ...
    template: {
        ...
        templateNameErrorMsg1: 'The name contains 6 to 32 characters, which can include letters, digits, hyphens (-)and underscores (_).',
        ...
        addRAIDGroupErrorMsg: "The model LSI2308(SR120/RU120),LSI3008(SR130/RU130) and Avago SAS3004iMR, up to only create 2 raid groups.",
        ...
        validateRAIDDiskGorupErrorMsg7: "A RAID 1E group must contain three or more disks and the number of disks must be odd.",
        validateRAIDDiskGorupErrorMsg8: "A RAID 10 group contains at least two disk groups and each disk group can contain two disks only.",
        ...
        validateRAIDDiskGorupErrorMsg10: "A RAID 60 group contains at least two disk groups and each disk group contains at least three disks. The number of disks in each disk group must be the same.",
        ...
        validateRAIDDiskGorupErrorMsg12: "The Avago SAS3004iMR,A RAID 0 group supports one to two disks.",
        softSourceVersion: 'Software Source Version',
        templateDescErrorMsg: "TemplateDesc must be between 0 and 128 letters.",
        templateDescErrorMsg1: "The value contains a maximum of 128 characters, including letters, digits, underscores (_), hyphens (-), and spaces.",
        ...
        NTPMixPollingInterval:"Min.NTP Time Sync Interval",
        NTPMaxPollingInterval:"Max.NTP Time Sync Interval",
        NTPPollingIntervalTip: "Minimum polling interval must be smaller than the maximum polling interval",
        rebuildRate:'Rebuild rate(%)',
        migrateRate:'Migrate rate(%)',
        JBOD:'JBOD model',
        patrol:'Disk patrol',
        RaidSlot:'RAID slot',
        patrolDelay:'Disk patrol delay (Hour)',
        rebuildRateErrorTips:'Please enter an integer between 1~100',
        PatrolDelayErrorTips:'Please enter an integer between 1～65535',
        stripSize:'Strip size',
        PDCache:'Drive cache',
        deleteOldRaidTips:'If Delete original RAID is selected,disk group data will be deleted from the original and to-be-configured RAID policies on the device side.',
        RaidSolotTips:'The 0 slot indicates the motherboard card,and the remaining slots indicate the PCIe slot.',
        LUNSizeErrorTips:'Invalid value, please retry.',
        deployOStips:'For Suse, RedHat, CentOS, you can choose mount point names from the drop-down box, or manually enter. The mount point name should comply with the constraint of the relevant OS.',
    },
    vCenter: {
        save: 'Save',
        ...
        loadingText: 'Configuring, please wait...',
        prompt: 'prompt',
    ...
    CNA_template: {
        ...
        input31az09:'Enter a string of 0 to 31 characters, including lowercase letters (a-z) and digits (0-9). The value must contain at least one letter.',
        ...
        input223az09: "Enter a string of 11 to 223 characters, including digits (0-9), lowercase letters (a-z), dots (.), colons (:), and hyphens (-).",
