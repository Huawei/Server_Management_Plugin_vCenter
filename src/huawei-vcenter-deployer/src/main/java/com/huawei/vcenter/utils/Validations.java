...
import com.huawei.vcenter.VcenterDeployerApplication;
...
public class Validations {
    ...
    public static String unsubscribeAlarm(String vcenterIP, String vcenterUsername, String vcenterPassword, String action) {
        String result = null;
        try {
            ...
            result = HttpRequestUtil.requestWithBody(String.format(RESTURL_UNSUBSCRIBE, vcenterIP), HttpMethod.POST, HEADERS, body, String.class).getBody();
