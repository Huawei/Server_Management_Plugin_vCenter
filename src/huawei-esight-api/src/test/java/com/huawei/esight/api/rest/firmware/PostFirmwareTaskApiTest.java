 ...
 */
public class PostFirmwareTaskApiTest {
    @Test
    public void testCall() {
        Map dataMap = new PostFirmwareTaskApi<Map>(EsightHelper.getEsight()).doCall(Collections.<String, String>emptyMap(), Map.class);
