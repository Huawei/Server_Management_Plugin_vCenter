 ...
 */
public class PutNotificationCommonAlarm<T> extends EsightOpenIdCallable<T> {

    public PutNotificationCommonAlarm(Esight esight) {
        super(esight);
    }

    public PutNotificationCommonAlarm(Esight esight, OpenIdProvider openIdProvider) {
